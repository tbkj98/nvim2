return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>le", fzf.lsp_document_diagnostics, { desc = "FZF: LSP -> Find diagnostics errors" })
    vim.keymap.set("n", "<leader>lE", fzf.lsp_workspace_diagnostics, { desc = "FZF: LSP -> Find diagnostics errors" })
